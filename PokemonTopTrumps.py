...
while True:
    ...
    print("You have {}, which has the following stats: ".format('name', 'stats'))
    for stat, value in player_pokemon['stats'].items():
        print("{}: {}".format(stat.capitalize(), value))


    # Compare the stats and print the result
    player_stat = input("Choose a stat to compare (hp, attack, defense, special-attack, special-defense, speed): ")
